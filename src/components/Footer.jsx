    ...
    <footer className="bg-secondary">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-8 text-tertiary">
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-md sm:text-center flex"><a href="#" className="hover:underline hover:text-white">
            ...
            &nbsp; + &nbsp;
            <svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 22">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="https://github.com/tonylxm" target="_blank" className=" hover:text-white ms-5">
