      ...
      <div className="flex justify-center bg-blue-200">
        <div className='mt-28'>
          ...
          <div className="flex mt-8 justify-center">
            <a href="https://www.linkedin.com/in/tonylxm/" className="text-gray-600 hover:text-black">
            ...
            <a href="https://github.com/tonylxm" className="text-gray-600 hover:text-black ms-5">
