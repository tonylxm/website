    ...
    <div className={`${styles.screen} z-0`}>
      ...
      <div className="flex-[0.85] sm:flex-[0.75] md:flex-[0.65] lg:flex-[0.5] z-20 overflow-hidden">
        <Animation>
          ...
          <div className={`${styles.sectionText} text-tertiary flex mt-3 justify-center items-center`}>
            <a
            ...
            <a
              ...
              target="_blank"
              className="hover:text-white ms-3 md:ms-4 lg:ms-5"
            >
              <svg
                className={styles.svg}
                aria-hidden="true"
          ...
          <div className={`${styles.sectionText} text-left text-white mt-4 sm:md:mt-6 lg:xl:mt-10`}>
