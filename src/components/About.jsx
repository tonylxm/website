      ...
      <div className="flex justify-center bg-secondary">
        <div className='mt-28'>
          ...
          <div className="flex mt-8 justify-center">
            <a href="https://www.linkedin.com/in/tonylxm/" className="text-tertiary hover:text-white">
            ...
            <a href="https://github.com/tonylxm" className="text-tertiary hover:text-white ms-5">
