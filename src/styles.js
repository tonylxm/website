const styles = {
  ...
  padding: "sm:px-16 px-6 lg:px-70 py-10",
  ...
  svg:"h-4 sm:md:h-5 lg:xl:h-6",

  heroHeadText: "font-black text-white text-[70px] xs:text-[70px] sm:text-[80px] md:text-[90px] lg:text-[120px] lg:leading-[95px] text-center",
  heroSubText: "text-[#dfd9ff] font-medium text-[16px] xs:text-[16px] sm:text-[18px] md:text-[20px] lg:text-[30px] lg:leading-[40px] lg:mt-12 text-center",

  sectionHeadText: "text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",
  sectionText: "text-[12px] sm:text-[14px] md:text-[16px] lg:xl:text-lg",
